...
int main( int argc, char *argv[])
{
    ...
    // string fq2 = argv[2];  
    thread_num = 10; 
    string fq1 = "/mnt/d/breakpoints/assembly/sim/sim_s_lugdunensis/fastq/APC_3758.1.fq";
    string fq2 = "/mnt/d/breakpoints/assembly/sim/sim_s_lugdunensis/fastq/APC_3758.2.fq";
    ...
    memset(-, 0, sizeof(char)*array_size);
