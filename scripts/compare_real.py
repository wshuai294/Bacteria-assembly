...
class Sample():
    ...
    def get_result(self):
        if self.method == "Our":
            self.result_fasta = self.result_dir + "/" + self.ID + ".contigs.final.fasta"
        elif self.method == "Spades":
...
class Benchmark():
    ...
    def get_para(self, run_script):
        ...
        for line in f:
            ...
            self.true_fasta_dict[ID] = array[1]
...
if __name__ == "__main__":
    run_script = "/mnt/d/breakpoints/assembly/sim/standard/truth.txt"
